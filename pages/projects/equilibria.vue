...
.four-three-container{
  position: relative;
  /* width: 100%;
  padding-top: 75%; */
}

.four-three-container::before {
  display: block;
  content: "";
  width: 100%;
  padding-top: 75%;
...
.four-three-container > :first-child{
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
